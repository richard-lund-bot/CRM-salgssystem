...
export const BUDSKAPSMALER = [
  ...
  // Bevegelse — prioriter det som støtter valgte evner og livsfølelse. Én
  // setning per dimensjon, så headeren har noe relevant uansett hva som er øverst.
  ...
  { id: 'beveg-indre-ro',  modul: 'bevegelse', dim: 'indre_ro',      niva: 'subtil', tekst: () => 'En rolig tur kan roe hodet like mye som kroppen.' },
  { id: 'beveg-mestring',  modul: 'bevegelse', dim: 'mestring',      niva: 'subtil', tekst: () => 'Bare det å komme i gang teller — resten følger ofte etter.' },
  { id: 'beveg-opplevelse', modul: 'bevegelse', dim: 'opplevelse',   niva: 'subtil', tekst: () => 'La turen bli en liten opplevelse, ikke en oppgave.' },
  { id: 'beveg-identitet', modul: 'bevegelse', dim: 'identitet',     niva: 'subtil', tekst: () => 'Litt bevegelse i dag er å være den du vil være.' },
  { id: 'beveg-bidrag',    modul: 'bevegelse', dim: 'bidrag',        niva: 'subtil', tekst: () => 'Litt overskudd fra en tur gir deg mer å gi andre.' },
  { id: 'beveg-tilhorighet', modul: 'bevegelse', dim: 'tilhorighet', niva: 'subtil', tekst: () => 'Ta med noen på turen — det er lettere å bevege seg sammen.' },
  { id: 'beveg-hverdag',   modul: 'bevegelse', dim: 'hverdagsglede', niva: 'subtil', tekst: () => 'Et lite pust ute kan løfte en helt vanlig dag.' },
  ...
  { id: 'ro-livskraft',    modul: 'ro', dim: 'livskraft',    niva: 'subtil', tekst: () => 'Litt ro nå kan gi mer overskudd senere.' },
  { id: 'ro-frihet',       modul: 'ro', dim: 'frihet',       niva: 'subtil', tekst: () => 'En pause er også å velge ditt eget tempo.' },
  { id: 'ro-mestring',     modul: 'ro', dim: 'mestring',     niva: 'subtil', tekst: () => 'Å stoppe opp litt er også noe du får til.' },
  { id: 'ro-opplevelse',   modul: 'ro', dim: 'opplevelse',   niva: 'subtil', tekst: () => 'Legg merke til én god ting akkurat nå.' },
  { id: 'ro-identitet',    modul: 'ro', dim: 'identitet',    niva: 'subtil', tekst: () => 'Å ta en pause er å ta vare på deg selv.' },
  { id: 'ro-bidrag',       modul: 'ro', dim: 'bidrag',       niva: 'subtil', tekst: () => 'Litt påfyll gjør det lettere å være der for andre.' },
  { id: 'ro-tilhorighet',  modul: 'ro', dim: 'tilhorighet',  niva: 'subtil', tekst: () => 'Stille nærvær med noen teller også som ro.' },
  { id: 'ro-hverdag',      modul: 'ro', dim: 'hverdagsglede', niva: 'subtil', tekst: () => 'Et rolig øyeblikk kan bli dagens lille lyspunkt.' },
  ...
  { id: 'mat-naerhet',     modul: 'mat', dim: 'naerhet',       niva: 'subtil', tekst: () => 'Et måltid sammen er en enkel måte å være til stede på.' },
  { id: 'mat-livskraft',   modul: 'mat', dim: 'livskraft',     niva: 'subtil', tekst: () => 'Litt grønt på tallerkenen gir energi til resten av dagen.' },
  { id: 'mat-frihet',      modul: 'mat', dim: 'frihet',        niva: 'subtil', tekst: () => 'Enkel, god mat gjør det lettere å holde det gående på din måte.' },
  { id: 'mat-indre-ro',    modul: 'mat', dim: 'indre_ro',      niva: 'subtil', tekst: () => 'Ta måltidet i ditt eget tempo — det er lov å spise rolig.' },
  { id: 'mat-mestring',    modul: 'mat', dim: 'mestring',      niva: 'subtil', tekst: () => 'Ett enkelt, godt valg på tallerkenen er nok.' },
  { id: 'mat-opplevelse',  modul: 'mat', dim: 'opplevelse',    niva: 'subtil', tekst: () => 'La ett måltid bli en liten smaksopplevelse i dag.' },
  { id: 'mat-identitet',   modul: 'mat', dim: 'identitet',     niva: 'subtil', tekst: () => 'Å lage noe godt er en måte å ta vare på deg selv.' },
  { id: 'mat-bidrag',      modul: 'mat', dim: 'bidrag',        niva: 'subtil', tekst: () => 'Mat du deler er en fin liten måte å gi på.' },
  ...
  { id: 'sos-livskraft',   modul: 'sosialt', dim: 'livskraft',    niva: 'subtil', tekst: () => 'God kontakt gir ofte energi tilbake.' },
  { id: 'sos-frihet',      modul: 'sosialt', dim: 'frihet',       niva: 'subtil', tekst: () => 'Det er lov å ta kontakt på din egen måte, i ditt tempo.' },
  { id: 'sos-indre-ro',    modul: 'sosialt', dim: 'indre_ro',     niva: 'subtil', tekst: () => 'En god prat kan roe mer enn en stille kveld alene.' },
  { id: 'sos-mestring',    modul: 'sosialt', dim: 'mestring',     niva: 'subtil', tekst: () => 'Å ta det første lille steget mot noen teller.' },
  { id: 'sos-opplevelse',  modul: 'sosialt', dim: 'opplevelse',   niva: 'subtil', tekst: () => 'Del noe du har opplevd med noen — det blir større da.' },
  { id: 'sos-identitet',   modul: 'sosialt', dim: 'identitet',    niva: 'subtil', tekst: () => 'Å være der for noen er å være den du vil være.' },
  { id: 'sos-tilhorighet', modul: 'sosialt', dim: 'tilhorighet',  niva: 'subtil', tekst: () => 'Ett øyeblikk sammen minner deg på at du hører til.' },
  { id: 'sos-hverdag',     modul: 'sosialt', dim: 'hverdagsglede', niva: 'subtil', tekst: () => 'En liten hilsen kan lyse opp en vanlig dag — for begge.' },
