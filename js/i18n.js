...
const EN = {
 ...
 "Slette ALT — profil, logg, streaks og historikk? Kan ikke angres.": "Delete EVERYTHING — profile, log, streaks and history? Cannot be undone.",
 ...
 "Logg dagens kontakt": "Log today’s connection",
 "Hva gjorde du i dag?": "What did you do today?",
 "Se fremgang": "See progress",
 "Annet": "Other",
 "Vis logg": "Show log",
 "Logget": "Logged",
 "Ta vare på noen": "Reach out to someone",
 "Se alle": "See all",
 "Legg til": "Add",
 "Legg til en person": "Add a person",
 "Legg til noen du vil holde kontakt med": "Add someone you want to stay in touch with",
 "Din krets er de få du bryr deg om — som en «moai». Appen minner deg mykt på hvem det har gått en stund med.": "Your circle is the few you care about — like a “moai”. The app gently reminds you who it’s been a while with.",
 "Kom i gang": "Get started",
 "Skriv en takk": "Write a thank-you",
 "En liten hilsen varmer.": "A little greeting warms.",
 "Inviter til noe": "Invite to something",
 "Planlegg noe hyggelig.": "Plan something nice.",
 "Gi et kompliment": "Give a compliment",
 "Det løfter dagen.": "It lifts the day.",
 "Finn fellesskap i nærheten": "Find community near you",
 "Finn fellesskap": "Find community",
 "Din krets": "Your circle",
 "De få du vil holde varmt — som en «moai».": "The few you want to keep close — like a “moai”.",
 "Ingen i kretsen ennå": "No one in your circle yet",
 "Legg til noen få du vil holde kontakt med. Alt bor på telefonen din — vi henter aldri kontaktlista.": "Add a few people you want to stay in touch with. Everything stays on your phone — we never read your contacts.",
 "Rediger": "Edit",
 "Bilde": "Picture",
 "Relasjon": "Relationship",
 "Fjern": "Remove",
 "Hvordan holder dere kontakt?": "How do you keep in touch?",
 "Ring": "Call",
 ...
 "Kollega": "Colleague",
 "Partner": "Partner",
 "Nummeret lagres bare på telefonen din, og brukes til å åpne ringing/melding.": "The number is stored only on your phone, and used to open calling/messaging.",
 "Lagt til i kretsen": "Added to your circle",
 "Skriv inn et navn": "Enter a name",
 "Logg annen kontakt": "Log other connection",
 "Skriv kort hva du gjorde — alt som er ekte kontakt teller.": "Write briefly what you did — any real connection counts.",
 "Logg kontakt": "Log connection",
 "Skriv noe kort først": "Write something short first",
 "Marker som gjort": "Mark as done",
 "Kopiert — lim inn i en melding": "Copied — paste into a message",
 "Fremgang": "Progress",
 "Rytmen din — uten press. Én ekte kontakt om dagen er nok.": "Your rhythm — no pressure. One real connection a day is enough.",
 "dager med kontakt (uke)": "days with contact (week)",
 "i kretsen sist uke": "in your circle last week",
 "Denne uka": "This week",
 "Verdt et dult": "Worth a nudge",
 ...
 "Å bli med i noe fast er en av de sikreste veiene ut av ensomhet. Her er ekte, landsdekkende steder å starte.": "Joining something regular is one of the surest ways out of loneliness. Here are real, nationwide places to start.",
 "En stund siden sist.": "A while since last time.",
 "Lenge siden sist.": "Long since last time.",
 "Flere uker siden sist.": "Several weeks since last time.",
 "Ta kontakt for første gang.": "Reach out for the first time.",
 "Snakket i går.": "Talked yesterday.",
 "Dere snakket i dag.": "You talked today.",
 ...
 "Møtte noen": "Met someone",
 "Ringte noen": "Called someone",
 "Ringte en du er glad i": "Called a loved one",
 "Delte et måltid": "Shared a meal",
 "Ble med på noe": "Joined something",
 "Tilhørighet holder deg frisk": "Belonging keeps you well",
 "Finn møteplasser i nærheten": "Find gathering places near you",
 "Laster…": "Loading…",
 "På Okinawa kalles det «moai» — en fast gjeng du hører til hele livet. Sterke bånd til andre er blant de kraftigste faktorene for et langt liv. Huk av de gode sosiale valgene dine i dag.": "On Okinawa they call it “moai” — a fixed group you belong to for life. Strong ties to others are among the most powerful factors for a long life. Tick off your good social choices today.",
 "Første møte": "First connection",
 "Ditt første sosiale valg": "Your first social choice",
 "Sosial uke": "A social week",
 "Sosiale valg 7 dager": "Social choices for 7 days",
 "Sosial streak 3 dager": "Social streak of 3 days",
 "Fast moai": "A steady moai",
 "Sosial streak 14 dager": "Social streak of 14 days",
 "Sosiale valg 30 dager": "Social choices for 30 days",
 "Mitt hvorfor": "My why",
 "På Okinawa kaller de det ikigai — grunnen til at du står opp om morgenen. Et tydelig hvorfor er blant de sterkeste kreftene for et langt, godt liv. De små valgene dine peker hit.": "On Okinawa they call it ikigai — the reason you get up in the morning. A clear why is among the strongest forces for a long, good life. Your small choices point here.",
 "Skriv ned grunnen din — det du kommer tilbake til når dagen er tung.": "Write down your reason — the one you come back to when the day is hard.",
 "Skriv ditt hvorfor": "Write your why",
 "Legg til et hvorfor til": "Add another why",
 ...
 "Ett rolig øyeblikk i uka — ikke en oppgave. Hva av det du gjorde betydde noe?": "One calm moment in the week — not a task. What of what you did mattered?",
 "Hva føltes mest meningsfullt denne uka?": "What felt most meaningful this week?",
 "Lagre refleksjonen": "Save the reflection",
 "Oppdater": "Update",
 "Refleksjon lagret": "Reflection saved",
 "Meningsdagbok": "Meaning journal",
 "Ett steg nærmere": "One step closer",
 "Uke fra": "Week of",
 "Utforsk": "Explore",
 "Kunnskap og inspirasjon for gode år.": "Knowledge and inspiration for good years.",
 "Les etter pilar": "Read by pillar",
 "Kunnskap & inspirasjon": "Knowledge & inspiration",
 "Dagens feed": "Today's feed",
 "Spillbar kunnskap — ett kort av gangen": "Playable knowledge — one card at a time",
 "Utforsk kunnskap & inspirasjon": "Explore knowledge & inspiration",
 "Les": "Read",
 "Kunne ikke laste akkurat nå.": "Could not load right now.",
 "Fargemodus": "Colour mode",
 "Lys papir eller skogsgrønn mørk modus. «Auto» følger systemet ditt.": "Light paper or deep-green dark mode. “Auto” follows your system.",
 "Auto": "Auto",
 "Lys": "Light",
 "Mørk": "Dark",
 ...
 "av dagsmålet": "of daily goal",
 "Ferdig i dag": "Done today",
 "Én rolig økt": "One calm session",
 "Ett sosialt valg": "One social choice",
 "rolige økter i dag": "calm sessions today",
 "Hele dager": "Complete days",
 "Første hele dag": "First complete day",
 "Alle fire vanene på samme dag": "All four habits on the same day",
 "3 hele dager": "3 complete days",
 "Alle fire vanene 3 dager på rad": "All four habits 3 days in a row",
 "7 hele dager": "7 complete days",
 "Alle fire vanene 7 dager på rad": "All four habits 7 days in a row",
 "14 hele dager": "14 complete days",
 "Alle fire vanene 14 dager på rad": "All four habits 14 days in a row",
 "30 hele dager": "30 complete days",
 "Alle fire vanene 30 dager på rad": "All four habits 30 days in a row",
 "Alle fire i dag": "All four today",
 "Alle fire vaner i dag.": "All four habits today.",
