...
const EN = {
 ...
 "Pustet rolig": "Breathed calmly",
 "Var uten skjerm": "Was screen-free",
 "Ba / mediterte": "Prayed / meditated",
 "Tok en liten pause": "Took a short break",
 "Var ute i naturen": "Was out in nature",
 "Se logg": "See log",
 "Start på 2 minutter": "Start with 2 minutes",
 "For kvelden": "For the evening",
 "1 min pust": "1 min breathing",
 "Kort kroppsskann": "Short body scan",
 "Stillhet": "Stillness",
 "Pust inn": "Breathe in",
 "Pust ut": "Breathe out",
 "Ferdig": "Done",
 "Godt gjort — det teller.": "Well done — it counts.",
 "Ro-logg": "Calm log",
 "Rytmen din — uten press. Én liten pause om dagen er nok.": "Your rhythm — no pressure. One small pause a day is enough.",
 "rolige dager (uke)": "calm days (week)",
 "valg i dag": "choices today",
 "med ro. Én liten pause er nok.": "with calm. One small pause is enough.",
 ...
 "Det er en stund siden du justerte kompasset. Kanskje verdt et blikk i dag.": "It has been a while since you adjusted your compass. Maybe worth a look today.",
 ...
 "Skriv fritt i noen minutter — eller sitt bare litt med spørsmålet.": "Write freely for a few minutes — or just sit with the question for a while.",
 "Reflekter": "Reflect",
 "Gå videre uten": "Continue without",
 "Trykk for å gå videre": "Tap to continue",
 "Neste": "Next",
 "Refleksjon": "Reflection",
 "Trykk på skjermen når du er ferdig.": "Tap the screen when you are done.",
 "Dagens brief": "Daily brief",
 "Vis hver morgen": "Show every morning",
 "En rolig start ved dagens første åpning — et blikk på dagen, kompasset ditt og et spørsmål å ta med.": "A calm start at the day's first opening — a look at the day, your compass and a question to carry.",
 ...
 "Når kjente du deg sist som en del av noe — og hva bygger du på i dag?": "When did you last feel part of something — and what are you building on today?",
