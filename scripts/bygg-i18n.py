...
EN = {
 ...
 'Verden er stille. Ta det med deg.': 'The world is quiet. Carry that with you.',
 'Dagen har så vidt begynt. Pust ut.': 'The day has only just begun. Breathe out.',
 'Det er god tid. Dagen er fortsatt ung.': 'There is plenty of time. The day is still young.',
 'Et lite pusterom midt på dagen.': 'A little breathing space in the middle of the day.',
 'Et rolig blikk før kvelden tar over.': 'A calm look before the evening takes over.',
 'Et blikk på dagen': 'A look at the day',
 'Én økt står i planen i dag.': 'One session is in the plan today.',
 'Ingenting må skje i dag. Dagen er åpen.': 'Nothing has to happen today. The day is open.',
 'Kompasset ditt': 'Your compass',
 'Det er en stund siden du justerte kompasset. Kanskje verdt et blikk i dag.':
   'It has been a while since you adjusted your compass. Maybe worth a look today.',
 'Dagens spørsmål': "Today's question",
 'Ikke svar med en gang. La det ligge i bakhodet.': "Don't answer right away. Let it rest in the back of your mind.",
 'Før dagen drar i gang': 'Before the day gets going',
 'Har du penn og papir i nærheten?': 'Do you have pen and paper nearby?',
 'Skriv fritt i noen minutter — eller sitt bare litt med spørsmålet.':
   'Write freely for a few minutes — or just sit with the question for a while.',
 'Reflekter': 'Reflect', 'Gå videre uten': 'Continue without', 'Trykk for å gå videre': 'Tap to continue',
 'Neste': 'Next', 'Refleksjon': 'Reflection',
 'Trykk på skjermen når du er ferdig.': 'Tap the screen when you are done.',
 'Dagens brief': 'Daily brief', 'Vis hver morgen': 'Show every morning',
 'En rolig start ved dagens første åpning — et blikk på dagen, kompasset ditt og et spørsmål å ta med.':
   "A calm start at the day's first opening — a look at the day, your compass and a question to carry.",
 # Dagens brief — morgenspørsmål (kompassets dimensjoner)
 'Hvem fortjener litt mer av deg i dag?': 'Who deserves a little more of you today?',
 'Hvem kunne trengt å høre fra deg i dag?': 'Who could use hearing from you today?',
 'Hva ville det bety å være helt til stede i dag?': 'What would it mean to be fully present today?',
 'Hva gir deg energi — og får det plass i dag?': 'What gives you energy — and does it get room today?',
 'Hva trenger kroppen din av deg i dag?': 'What does your body need from you today?',
 'Når kjente du deg sist sterk — og hva skal til i dag?': 'When did you last feel strong — and what would it take today?',
 'Hva ville du gjort i dag om ingenting holdt deg igjen?': 'What would you do today if nothing held you back?',
 'Hvilket lite valg kan gjøre dagen friere?': 'What small choice could make the day freer?',
 'Hva kan du si nei til i dag?': 'What can you say no to today?',
 'Hvor i dagen kan du legge inn et pusterom?': 'Where in the day can you fit a breathing space?',
 'Hva kan få vente — helt ærlig?': 'What can wait — honestly?',
 'Hvilket tempo passer deg egentlig i dag?': 'What pace actually suits you today?',
 'Hva vil du være litt stolt av i kveld?': 'What do you want to be a little proud of tonight?',
 'Hvilket lite steg kan du ta i dag?': 'What small step can you take today?',
 'Hva øver du på for tiden — og hva er neste steg?': 'What are you practising these days — and what is the next step?',
 'Hva kan du legge merke til i dag som du vanligvis går forbi?': 'What can you notice today that you usually walk past?',
 'Hvilket lite øyeblikk kan du skape i dag?': 'What little moment can you create today?',
 'Hva ville gjort i dag verdt å huske?': 'What would make today worth remembering?',
 'Hvem vil du være i dag — i det små?': 'Who do you want to be today — in the small things?',
 'Hvilket valg i dag ligner mest på den du vil være?': 'Which choice today looks most like the person you want to be?',
 'Hva står du for når dagen setter deg på prøve?': 'What do you stand for when the day tests you?',
 'Hvem kan få det litt bedre fordi du finnes i dag?': 'Who can have it a little better because of you today?',
 'Hva kan du gi i dag uten at noen ber om det?': 'What can you give today without being asked?',
 'Hvilket lite bidrag ville gjort deg glad å gi?': 'What small contribution would make you happy to give?',
 'Hvem er dine folk — og vet de det?': 'Who are your people — and do they know it?',
 'Når kjente du deg sist som en del av noe — og hva bygger du på i dag?':
   'When did you last feel part of something — and what are you building on today?',
 'Hva kan du gjøre i dag for fellesskapet du er glad i?': 'What can you do today for the community you love?',
 'Hva er det minste som kan gjøre dagen god?': 'What is the smallest thing that could make the day good?',
 'Hva gleder du deg til i dag — finnes det noe lite?': 'What are you looking forward to today — is there something small?',
 'Hvilken liten glede kan du unne deg i dag?': 'What little joy can you allow yourself today?',
 # Dagens brief — nøytrale morgenspørsmål
 'Hva ville gjort dagen god — helt enkelt?': 'What would make the day good — quite simply?',
 'Hva betyr mest i dag?': 'What matters most today?',
 'Hva trenger du mer av for tiden?': 'What do you need more of these days?',
 'Hva vil du takke deg selv for i kveld?': 'What will you thank yourself for tonight?',
 'Hva kan du gjøre i dag som du er glad for i morgen?': 'What can you do today that you will be glad about tomorrow?',
 'Hvilket lite valg kan løfte dagen?': 'What small choice could lift the day?',
 'Hva fortjener oppmerksomheten din i dag?': 'What deserves your attention today?',
 'Hva kan du slippe taket i i dag?': 'What can you let go of today?',
}
