...
EN = {
 ...
 'Minutter i dag': 'Minutes today', 'Aktive dager': 'Active days', 'XP til neste nivå': 'XP to next level',
 ...
 # Varsler
 'Ingen varsler ennå': 'No notifications yet', 'Nytt globalt nivå — bra jobba.': 'New global level — well done.',
 'Nivå': 'Level', 'nivå': 'level', 'XP': 'XP',
